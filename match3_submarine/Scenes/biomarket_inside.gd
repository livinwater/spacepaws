...
func _ready():
	...
	var chest_button = $Chest2  # Changed from $Chest to $Chest2
	if chest_button:
	...
	back_button.position = Vector2(50, 50)  # Adjust position as needed
...
func _on_chest_pressed() -> void:
	print("Chest clicked!")  # Add this line
...
func _on_chest_open_confirmed():
	...
	# Here you would typically update the player's inventory with the reward
